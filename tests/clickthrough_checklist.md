...
| [ ] 7 | Q3: Submit true_false_multi | Advances to `/quiz/4`  | | |
| [ ] 8 | Q4: Click correct zone on skeleton | Submit button becomes enabled  | | |
| [ ] 9 | Q4: Submit spot_click | Advances to `/result`  | | |
| [ ] 10 | View Result page | Score displays correctly out of 4 | | |
| [ ] 11 | Click Restart | Returns to `/` and session resets  | | |
| [ ] 12 | Use Browser Back Button | App does not crash at any stage  | | |
